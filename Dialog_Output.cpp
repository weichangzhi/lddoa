...
BOOL CDialog_Output::OnInitDialog() 
{
	...
	m_list_output.InsertColumn(3, _T("经办人"), LVCFMT_LEFT,80);
	m_list_output.InsertColumn(4, _T("设计师"), LVCFMT_LEFT,80);
	m_list_output.InsertColumn(5, _T("积分"), LVCFMT_LEFT,60);
	...
	m_list_output.InsertColumn(11, _T("快递单号"), LVCFMT_LEFT,180);
	...
	m_list_total.InsertColumn(4, _T(""), LVCFMT_LEFT,80);
	m_list_total.InsertColumn(5, _T(""), LVCFMT_LEFT,60);
	...
	m_list_total.InsertColumn(11, _T(""), LVCFMT_LEFT,180);
