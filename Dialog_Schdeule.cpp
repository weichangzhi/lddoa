...
BOOL CDialog_Schdeule::OnInitDialog() 
{
	...
	m_list_schedule.InsertColumn(9, _T("业务"), LVCFMT_LEFT,170);
	m_list_schedule.InsertColumn(10, _T("技术部"), LVCFMT_LEFT,170);
	m_list_schedule.InsertColumn(11, _T("生产部"), LVCFMT_LEFT,170);
	m_list_schedule.InsertColumn(12, _T("质检"), LVCFMT_LEFT,170);
	m_list_schedule.InsertColumn(13, _T("成品仓"), LVCFMT_LEFT,170);
	m_list_schedule.InsertColumn(14, _T("物流"), LVCFMT_LEFT,170);
		    ...
		    if(result)
            {
                ...
                while(sql_row=mysql_fetch_row(result))//获取具体的数据
                {
					...
					case 0://过账时间
						...
						break;
					case 1://停留时间
						m_list_schedule.SetItemText(index,9,"0");						
						for(i=10;i<=14;i++)
						{
